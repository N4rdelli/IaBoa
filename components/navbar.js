    ...
    this.innerHTML = `
      <nav class="bg-[#1A1423] text-white text-xs lg:text-sm font-light tracking-wide leading-none py-4 px-8 md:px-16 lg:px-32 flex justify-between items-center">
        ...
        <ul class="hidden md:flex space-x-6">
          <li><a href="../index.html" class="text-gray-300 hover:text-white">Página Inicial</a></li>
          <li><a href="../pages/sobre.html" class="text-gray-300 hover:text-white">Sobre o Projeto</a></li>
          <li><a href="../pages/desenvolvedores.html" class="text-gray-300 hover:text-white">Desenvolvedores</a></li>
        </ul>
        ...
        <div class="hidden md:flex space-x-6 items-center">
          ...
          ` : `
            ...
            <button class="bg-[#DB2763] px-4 py-2 lg:px-8 rounded-md hover:bg-[#B01D4F] transition-colors duration-200 cursor-pointer">Entrar</button>
          `}
        </div>
      </nav>
      ...
      <div id="offcanvas" class="fixed top-0 left-0 h-full w-64 bg-[#1A1423] text-white text-sm font-light tracking-wide leading-none transform -translate-x-full transition-transform duration-300 z-50 shadow-lg">
        ...
        <nav class="flex flex-col space-y-8 p-4">
          <div class="flex flex-col space-y-4">
            <a href="../index.html" class="text-gray-300 hover:text-white">Página Inicial</a>
            <a href="../pages/sobre.html" class="text-gray-300 hover:text-white">Sobre o Projeto</a>
            <a href="../pages/desenvolvedores.html" class="text-gray-300 hover:text-white">Desenvolvedores</a>
          </div>
          <div class="flex flex-col space-y-2">
            ...
            ` : `
              ...
              <button class="bg-[#DB2763] px-4 py-2 rounded-md hover:bg-[#B01D4F] transition">Entrar</button>
            `}
          </div>
        </nav>
      </div>
